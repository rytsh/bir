  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        id: "bcrypt-generator",
        name: "Bcrypt",
        description: "Generate and validate bcrypt password hashes",
        icon: "🔐",
        path: "/generators/bcrypt",
        keywords: "bcrypt, bcrypt generator, bcrypt validator, password hash, hash generator, password hashing, bcrypt hash, secure password",
      },
      {
        id: "hash-generator",
        name: "Hash",
      ...
      },
      {
        id: "id-generator",
        name: "ID",
        description: "Generate UUIDs (v1, v4, v7), ULIDs, and Nano IDs",
        icon: "🏷️",
        path: "/generators/id",
        keywords: "uuid generator, ulid generator, nanoid generator, unique id, uuid v1, uuid v4, uuid v7, identifier generator, random id, unique identifier, nano id",
      },
      {
        id: "key-generator",
        name: "RSA Key",
