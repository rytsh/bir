  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        id: "dice-roller",
        name: "Dice Roller",
        description: "Roll dice of various sizes with presets for D&D, board games, and more",
        icon: "🎲",
        path: "/party/dice",
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        id: "translate",
        name: "Translate",
        description: "Translate text between 100 languages using AI (M2M-100) directly in your browser. Supports speech input for voice-to-text translation.",
        icon: "🌐",
        path: "/ai/translate",
        keywords: "translate, translation, language, m2m100, multilingual, speech to text, voice input, translator, localization",
        wasm: true,
      },
      {
        id: "background-remover",
        name: "Background Remover",
        description: "Remove backgrounds from portrait images using AI (MODNet) directly in your browser. Best for photos with people.",
        icon: "🪄",
